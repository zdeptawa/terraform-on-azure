# terraform-on-azure - Terraform AKS Deployment Demo
# Deploying an Azure Kubernetes Service (AKS) Cluster and Demo Pod/Service with Terraform
Very basic sample Terraform configuration utilizing the AzureRM Terraform Provider to deploy an
Azure Kubernetes Service (AKS) Cluster. Also deploys a demo nginx pod and service using Terraform.
...
$ cd terraform-on-azure/demos/demofolder                        # changing directory to demo folder
$ . /path/to/demo_env_vars_file.sh                              # sourcing creds file to export as env vars
